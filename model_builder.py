...
def main():
    ...
    #M.viewGeometry()
    M.addSource(mp.Source(mp.ContinuousSource(frequency=0.1,width=20),component=mp.Ez,center=mp.Vector3(-31,0),size=mp.Vector3(0,10)))
    M.simulate(resolution=20,until=600)
